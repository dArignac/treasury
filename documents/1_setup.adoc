...
Within the Firebase Console go to the _"Project Overview"_ and add Firebase to a webapp (click the icon with _"</>"_), grab the displayed Firebase settings and update the development and/or production environment file you created before with it:
